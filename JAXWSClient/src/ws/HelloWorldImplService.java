 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8081/JAXWSServer/WS/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/JAXWSServer/WS/HelloWorld?wsdl");
