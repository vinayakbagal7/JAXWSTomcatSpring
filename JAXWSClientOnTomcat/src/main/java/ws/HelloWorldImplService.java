 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/JAXWSServerOnTomcat/HelloWorldWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/JAXWSServerOnTomcat/HelloWorldWS?wsdl");
